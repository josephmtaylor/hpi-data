...
if (!empty($addressId)) {
	...
	if ($isRecordExists == 1) { 
			...
			$phone		=	$ADR->prepare_output( trim($data['phone']) );
			$notes		=	$ADR->prepare_output( trim($data['notes']) );
			$fax		=	$ADR->prepare_output( trim($data['fax']) );
        	...
        	<div class="invoice_inner">
                ...
                <div class="one_half">
                    ...
                    <div id="adrinfo1" class="one_half last alignright">
                        <?php echo trim($phone); ?> <br />
                        <?php echo trim($fax); ?> <br />
                        <?php echo trim($showStatus); ?><br />
                        <?php echo trim($notes); ?>
                    </div><!-- one_half last -->
                </div><!-- one_half last -->
                ...
                <div class="one_half last">
                    ...
                    <div id="adrinfo2" class="one_half last alignright">
                        ...
                        <?php echo trim($city); ?><br />
                        <?php echo trim($state); ?><br />
                        <?php echo trim($zip); ?><br />
                        <?php echo trim($county); ?>
                    </div><!-- one_half last -->
                </div><!-- one_half last -->
                </div>
				...
				if (!empty($docRec)) {
				 ...
				 ?>
                        ...
                        <div id="doc_<?php echo $did;?>" class="one_half">
							...
							<?php if (!empty($fax)) { echo '<strong>Fax # </strong>'. $fax . '<br />'; } ?> 
							<?php if (!empty($npi)) { echo '<strong>NPI #</strong> '. $npi . '<br />';  } ?> 
                            <?php if (!empty($advertiser)) { echo '<strong>Advertiser #</strong> '. $advertiser . '<br />';  } ?> 
                                ...
                                <div id="divupd" class="form_new">
                                    <fieldset>
										...
										<p>
                                            ...
                                            <input name="cphone" type="text" class="sf"  id="cphone" value="" />
                                        </p>
										
										<p>
                                            <label for="fax">Fax</label>
                                            <input name="cfax" type="text" class="sf"  id="cfax" value="" />
                                        </p>
										...
										<p>
                                            ...
                                            <input id="advertiser" name="advertiser" type="checkbox" value="Y" style="margin-top:5px;" />
                                        </p>
                                        <p class="one_half">
