...
class CenterHropClass extends Db { 
		...
		{
				$sqlQuery  =   "SELECT  DP.center_id, DP.hrop_id, P.hours_of_operation
								FROM `center_hours_of_operation` AS DP INNER JOIN `hours_of_operations` AS P ON P.hrop_id = DP.hrop_id
