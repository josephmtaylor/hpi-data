						...
						<?php
							...
							<?php	
								 for ($i=0; $i < $totalChapter; $i++) { 
									$spid = $spRec[$i]['chapter_id'];
									$chapter = $spRec[$i]['chapter_name'];
							?>	
								<option value="<?php echo $spid; ?>" <?php if ($chapter_id_fk == $spid) { ?> selected="selected" <?php  } ?> ><?php echo $chapter; ?></option>
							<?php 	 } 
								}
								else {
							?>	
