...
jQuery(document).ready(function(){
	...
	jQuery("#form").validate({
		...
		submitHandler: function() {
				...
				var dataString = 'action=' + action + '&adrid=' + uid +  '&docid=' + docid + '&full_name=' +  $("#full_name").val() + '&first_name=' +  $("#first_name").val() + '&last_name=' +  $("#last_name").val() + '&npi=' +  $("#npi").val() + '&specialty_id_fk=' +  $("#specialty_id_fk").val() + '&category_id_fk=' +  $("#category_id_fk").val() + '&notes=' +  $("#doctor_notes").val() + '&status=' +  $("#doctor_status").val()  + '&new=' +  $("#new").val();
	...
	jQuery("#formcnr").validate({
		...
		submitHandler: function() {
				...
				var dataString = 'action=' + action + '&adrid=' + uid +  '&cnid=' + cnid + '&name=' +  $("#name").val() + '&npi=' +  $("#npi").val() + '&specialty_id_fk=' +  $("#specialty_id_fk").val() + '&category_id_fk=' +  $("#category_id_fk").val() + '&description=' +  $("#center_description").val() + '&notes=' +  $("#center_notes").val() + '&status=' +  $("#center_status").val()  + '&new=' +  $("#new").val();
	...
	if (errors == 1) { 
		...
		if (fm==1) {
			...
			if (ne == 1) {
				...
				var stradr = stradr +'<strong>Specialty # </strong> '+specialty+'<br />'+'<strong>NPI #</strong> '+npi+ '<br />' + '<strong>Current Status #</strong> ' + current_status + '<br /><strong>Notes #</strong> ' + notes +  '<br /><br /></div>';
			
				document.getElementById('loaddr').innerHTML = ol+stradr;	
			}
			else if (ne == 0) {
				var stradr = '<h3>'+ doctor_name +'</h3><br />';
				var stradr = stradr +'<strong>Specialty # </strong> '+specialty+'<br />'+'<strong>NPI #</strong> '+npi+ '<br />' + '<strong>Current Status #</strong> ' + current_status + '<br /><strong>Notes #</strong> ' + notes + '<br /><br />';
	...
	if (errors == 1) { 
		...
		if (fm==1) {
			...
			if (ne == 1) {
				...
				var stradr = stradr +'<strong>Category # </strong> '+category+'<br />'+'<strong>NPI #</strong> '+npi+ '<br />' + '<strong>Current Status #</strong> ' + current_status + '<br /><strong>Description #</strong> ' + description + '<br /><strong>Notes #</strong> ' + notes +  '<br /><br /></div>';
			
				document.getElementById('loaddr').innerHTML = ol+stradr;	
			}
			else if (ne == 0) {
				var stradr = '<h3>'+ center_name +'</h3><br />';
				var stradr = stradr +'<strong>Category # </strong> '+category+'<br />'+'<strong>NPI #</strong> '+npi+ '<br />' + '<strong>Current Status #</strong> ' + current_status + '<br /><strong>Description #</strong> ' + description + '<br /><strong>Notes #</strong> ' + notes + '<br /><br />';
				document.getElementById('doc_'+did).innerHTML = stradr;
			}
		}
	}
