...
class DoctorAddressClass extends Db { 
		...
		{
				$sqlQuery = "SELECT A.id, D.doctor_id, D.first_name, D.middle_name, D.last_name, D.fullname, D.notes, D.email, D.license_status, D.phone, D.fax, D.website, D.npi, D.status, D.advertiser, S.specialty_name
