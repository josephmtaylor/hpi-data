    ...
    <table cellpadding="0" cellspacing="0" border="0" class="dyntable" id="example">
            <thead>
                <tr>
                    ...
                    <th class="head1" width="10%">Phone</td>
                    <th class="head0" width="22%">Center Name</td>
                    <th class="head1" width="20%">Category</td>
                    <th class="head0" width="13%" align="center">Last Updated</td>
                    <th class="head1" width="5%" align="center">Status</td>
                    <th class="head1" width="5%" align="center">Action</td>
                </tr>
            </thead>
            <colgroup>
                <col class="con0" />
            ...
            <?php
                ...
                <tr>
                  ...
                  <td align="center"><span id="aid" style="display:none;"><?php echo $id; ?></span>&nbsp;<?php echo $status; ?>
                  </td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="head1" width="10%">Phone</td>
                    <th class="head0" width="22%">Center Name</td>
                    <th class="head1" width="20%">Chapter</td>
                    <th class="head0" width="13%" align="center">Last Updated</td>
                    <th class="head1" width="5%" align="center">Status</td>
                    <th class="head1" width="5%" align="center">Action</td>
                </tr>
