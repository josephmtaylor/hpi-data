...
if (isset($_GET["id"]))
{
	...
	$chRec = $CH->getList($fieldName='', $searchValue='', $orderByField='chapter_name', $orderByValue='ASC');	
	...
	$ctRec = $C->getList($fieldName='', $searchValue='',  $orderByField='city', $orderByValue='ASC');
	
	$totalStates = $S->getTotal();
	$stRec = $S->getList($fieldName='', $searchValue='', $orderByField='state', $orderByValue='ASC');
	
	$totalZips = $Z->getTotal();
	$zpRec = $Z->getList($fieldName='', $searchValue='',  $orderByField='zipcode', $orderByValue='ASC');
	
	//echo '<pre>'; print_r($stRec); print_r($ctRec);
